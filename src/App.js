  ...
  return(
    <>
      <div className='fixed flex w-full justify-between items-center h-14 px-6 z-10 text-lg text-white bg-gray-900/70'>
            ...
            <div onClick={handleNav} className={nav ? 'fixed left-0 top-0 w-full z-20 bg-gray-100/90 px-4 py-7 flex-col font-bold text-[#00739F]' : 'absolute left-[-100%] top-0 w-full bg-gray-100/90 px-4 py-7 flex-col'}>
                <ul>
                    <li>
                      <Link className ='px-3 ' to='/'> Accueil</Link>
                    </li>
