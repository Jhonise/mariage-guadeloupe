    ...
    return (
        <div>
            ...
            <div className='pt-10 pb-10 sm:pt-20 px-4 flex flex-col justify-center items-center w-full h-full border-b-8' >
                <div className='max-w-[1000px] w-full grid sm:grid-cols-2 gap-8'>
                    <div className='sm:text-right sm:pb-8 pb-4 pl-4'>
                        <p className='text-4xl sm:text-7xl font-bold inline text-[#CEA450] border-b-4 border-pink-600'> Tout savoir </p>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div className='grid sm:grid-cols-2 px-2 py-4'>   
                        <Link className ='px-3 text-pink-600 font-bold ' to='/informations'> Informations utiles </Link>
                        <Link className ='px-3 text-pink-600 font-bold' to='/faq'> FAQ </Link>
                    </div> 
                </div>
                </div>
            </div>
            ...
            <div className='pt-10 pb-20 sm:pt-20 px-4 flex flex-col justify-center items-center w-full h-full border-t-8'>
                <div className='max-w-[1000px] w-full grid sm:grid-cols-2 gap-8'>
                    <div className='sm:text-right sm:pb-8 pb-4 pl-4'>
                        <p className='text-4xl sm:text-7xl font-bold inline text-[#CEA450] border-b-4 border-pink-600'> Annou ay !</p>
                    </div>
                </div>
                <div className='max-w-[1000px] w-full grid sm:grid-cols-2 gap-8 px-4'>
                    <div className ='sm:text-right text-lg font-bold text-[#307C7C]'>
                ...
                <div>
                    ...
                    <div className='grid sm:grid-cols-2  pt-4'>   
                        <Link className ='px-3 text-pink-600 font-bold ' to='/agenda'> Agenda des mariés </Link>
                    </div> 
                </div>
                </div>
            </div>
